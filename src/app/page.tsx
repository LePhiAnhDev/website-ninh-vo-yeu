        ...
        <div className="min-h-screen">
            ...
            {gameState === 'complete' && (
                <div className="min-h-screen bg-gradient-to-br from-pink-love-100 to-pink-love-200 flex items-center justify-center p-2 sm:p-4">
                    <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-md w-full text-center animate-float">
                        <div className="text-4xl sm:text-6xl mb-4 animate-bounce-slow">🎊</div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-pink-love-600 mb-4 font-cute">
                            Hoàn thành! 💕
                        </h1>
                        ...
                        <button
                            onClick={resetGame}
                            className="bg-gradient-to-r from-pink-love-500 to-pink-love-600 text-white px-6 py-2 sm:py-3 rounded-lg font-semibold hover:from-pink-love-600 hover:to-pink-love-700 transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
                        >
                            Chơi lại 🎮
                        </button>
                    </div>
